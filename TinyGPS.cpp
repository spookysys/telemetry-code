...
#define _GPRMCterm   "G*RMC"
#define _GPGGAterm   "G*GGA"
...
bool TinyGPSPlus::endOfTermHandler()
{
  ...
  if (curTermNumber == 0)
  {
    if (strlen(term)>2 && term[0]=='G' && !strcmp(term+2, _GPRMCterm+2))
      curSentenceType = GPS_SENTENCE_GPRMC;
    else if (strlen(term)>2 && term[0]=='G' && !strcmp(term+2, _GPGGAterm+2))
